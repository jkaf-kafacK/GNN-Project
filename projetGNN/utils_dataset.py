# this code was imported from torch_geometric library https://pytorch-geometric.readthedocs.io/en/latest/_modules/torch_geometric/data/dataset.html#Dataset
# slight modification have been added
import copy
...
class Dataset(torch.utils.data.Dataset):
    ...
    def __repr__(self) -> str:
        arg_repr = str((self.__len__())) if self.__len__() > 1 else ''
